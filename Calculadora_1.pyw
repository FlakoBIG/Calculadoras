...
#                                   Funciones
def Volver():
    #abre el archivo que es un python y que se llama Main.pyw
    subprocess.Popen(['python','Main.pyw'])
    #destrulle la ventana 
    ventana.destroy()
...
btn_divicion = Button(ventana,text="Divicion",font="Arial 10",bg="yellow",fg="black",width=10,command=lambda:Validar("Dividir"))
